...
namespace GameLauncher.Forms
{
    partial class MainForm : Form
    {
        ...
        private Button _darkModeToggle = null!;
        ...
        private void InitializeComponent()
        {
            ...
            viewMenu.DropDownItems.Add(new ToolStripMenuItem("Toggle Dark Mode", null, (s, e) => _themeManager.ToggleTheme()));
            ...
            _darkModeToggle = new Button
            {
                Text = "🌙",
                Font = new Font("Segoe UI", 16),
                Size = new Size(50, 40),
                Anchor = AnchorStyles.Top | AnchorStyles.Right,
                Location = new Point(titlePanel.Width - 70, 20),
                FlatStyle = FlatStyle.Flat,
                Cursor = Cursors.Hand
            };
            _darkModeToggle.Click += (s, e) => _themeManager.ToggleTheme();
            
            titlePanel.Controls.Add(_titleLabel);
            titlePanel.Controls.Add(_darkModeToggle);
            
            // Handle panel resize to keep button positioned
            titlePanel.Resize += (s, e) => 
            {
                _darkModeToggle.Location = new Point(titlePanel.Width - 70, 20);
            };
        ...
        private Panel CreateGameCard(IGame game)
        {
            ...
            card.Controls.AddRange(new Control[] { iconPanel, titleLabel, descLabel, playButton });
        ...
        private void LaunchGame(IGame gameTemplate)
        {
            try
            {
                ...
                // Get the game window and show it
                ...
                if (gameWindow != null)
                {
                    gameWindow.FormClosed += (s, e) => 
                    {
                        ...
                        game.ScoreChanged -= OnGameScoreChanged; // Unsubscribe from events
                        game.Dispose();
                    };
                ...
                {
                    MessageBox.Show($"Failed to get game window for {game.DisplayName}", "Error",
                        MessageBoxButtons.OK, MessageBoxIcon.Error);
                    _statusLabel.Text = "Ready";
                }
            }
        ...
        private void ApplyTheme()
        {
            ...
            // Apply theme to dark mode toggle
            _darkModeToggle.BackColor = _themeManager.ButtonColor;
            _darkModeToggle.ForeColor = Color.White;
            _darkModeToggle.FlatAppearance.BorderColor = _themeManager.ButtonColor;
            _darkModeToggle.Text = _themeManager.IsDarkMode ? "☀️" : "🌙";
